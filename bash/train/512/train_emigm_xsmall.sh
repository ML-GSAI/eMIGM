...
exp_name=imagenet512_emigm_xsmall_d6w1280
train_word="--model emigm_xsmall --diffloss_d 6 --diffloss_w 1280  --save_epoch_name True --mask_strategy exp --use_mae True --clamp_t_min 0.2 --use_unsup_cfg True --batch_size 32 --evaluate_multi --num_images 10000 --cfg 2.9 --cfg_schedule linear --temperature 0.95 --eval_bsz 256"
# we using 32 batch size per gpu and uisng 32 gpus, so the total batch size is 32 * 32 = 1024
