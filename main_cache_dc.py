...
from engine_emigm import cache_latents_ae
...
def get_args_parser():
    ...
    parser.add_argument('--vae_path', default="pretrained_models/vae/dc-ae-f32c32-in-1.0", type=str,
    ...
    parser.add_argument('--num_workers', default=50, type=int)
...
def main(args):
    ...
    ae = DCAE_HF.from_pretrained(args.vae_path).cuda().eval()

    # training
    print(f"Start caching AE latents")
