...
exp_name=imagenet512_emigm_base_d8w1280
train_word="--model emigm_base --diffloss_d 8 --diffloss_w 1280  --save_epoch_name True --mask_strategy exp --use_mae True --clamp_t_min 0.2 --use_unsup_cfg True --batch_size 64 --evaluate_multi --num_images 10000 --cfg 2.9 --cfg_schedule linear --temperature 0.95 --eval_bsz 256"
